---
title: "Quickstart"
description: "Get started with DGrid in under five minutes — create an account, generate an API key, and make your first call to a model through the AI Gateway."
---
