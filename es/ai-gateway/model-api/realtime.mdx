...
description: "Crea sesiones Realtime API compatibles con OpenAI sobre DGrid para conversaciones de texto y audio de baja latencia mediante WebSocket con voz en streaming."
---
