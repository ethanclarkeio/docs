...
<Tip>
¿Quiere una ruta gratuita que seleccione automáticamente capacidad de modelo disponible? Consulte el [router de modelos gratuitos](/es/ai-gateway/free-models-router).
</Tip>
