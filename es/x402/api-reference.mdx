...
description: "Referencia de endpoints para la API x402 de DGrid, con formato de solicitud, cabeceras de pago, códigos de respuesta y detalles del cobro por inferencia."
---
