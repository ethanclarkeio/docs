...
description: "DGrid's x402 API lets developers pay per inference call using the x402 micropayment protocol — no API keys, accounts, or subscriptions required."
---
