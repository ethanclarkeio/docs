...
title: "AI Gateway"
sidebarTitle: "Aperçu"
description: "DGrid AI Gateway offre une API unifiée compatible OpenAI pour appeler plus de 200 modèles IA, avec paiement en crypto, routage et edge mondial intégré."
---
...
<Tip>
Vous voulez une route gratuite qui sélectionne automatiquement une capacité de modèle disponible ? Consultez le [routeur de modèles gratuits](/fr/ai-gateway/free-models-router).
</Tip>
