...
title: "快速入門"
sidebarTitle: "快速入門"
description: "5 分鐘快速上手 DGrid：建立帳戶、產生 API 金鑰，並透過 AI Gateway 完成您對模型的第一次呼叫，搭配 OpenAI 相容 SDK、curl 與 Python 範例逐步操作，協助開發者快速整合、驗證流程並順利進入後續完整應用開發階段，並引導讀者前往更深入的指南、API 範例與整合教學。"
---
