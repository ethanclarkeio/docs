...
title: "AI Gateway"
sidebarTitle: "總覽"
description: "DGrid AI Gateway 提供統一且相容 OpenAI 的 API 介面，可呼叫超過 200 種領先 AI 模型，並支援加密貨幣計費、智慧路由、自動故障轉移、全球邊緣節點存取、使用量監控、即時報表與成本分析等多項面向開發者的核心能力，並涵蓋 SLA 保證、計費透明度與多區域容錯設計。"
---
